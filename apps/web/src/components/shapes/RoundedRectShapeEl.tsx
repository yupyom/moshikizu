import type { RoundedRectShape } from '@draw/core';
...
export function RoundedRectShapeEl({ shape, selected, onPointerDown, onDoubleClick }: Props) {
    ...
    <g>
      ...
      {selected && (
        <rect
          ...
          rx={shape.cornerRadius + 1}
          ry={shape.cornerRadius + 1}
          fill="none"
          stroke="#2563eb"
          strokeWidth={2}
          vectorEffect="non-scaling-stroke"
